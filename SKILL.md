---
name: outline
description: Manage notes and documents in Outline knowledge base — create, read, edit, delete, list, search, archive, and restore documents across collections
metadata: {"bins": ["outline"], "env": ["OUTLINE_API_KEY"]}
---
